...
#ifndef SYSIF_KEYBOARD_H_
#define SYSIF_KEYBOARD_H_
...
#define KEYSYM_CTRL         0xF000 // added to the normal

// special keysyms

#define KEYSYM_RESET        0x8100
#define KEYSYM_SLEEP        0x8101
